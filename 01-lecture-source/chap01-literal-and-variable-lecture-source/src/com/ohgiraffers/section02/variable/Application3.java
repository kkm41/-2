package com.ohgiraffers.section02.variable;public class Application3 {
    public static void main(String[] args){
        ...
        *  2-8 boolean 형은 의문문으로 가급적 긍정형태로 네이밍 한다*/
        ...
        /*1.컴파일 에러를 발생시키는 규칙*/
        /*목차 1-1 동일한 범위 내에서 동일한 변수를 가질 수 있다*/
        int age = 20;
        //String age = ""; //동일한 변수명을 가지므로 에러 발생
        ...
        int age1 = 10; //숫자가 처음에 시작하지 않으면 섞어서 사용 가능하다

        /*목차 1-5 특수기호는 '_'와 '$'만 가능하다*/
        //int a@ge = 10; //사용 가능한 특수문자 외에는 사용 불가능
        int _a$ge = 10; //언더스코어,달러표시 사용가능함. 처음도 가능하고 중간이나 끝에도 가능함

        /*2.컴파일 에러를 발생시키지는 않지만 개발자들끼리 암묵적인 규칙*/
        /*목차 2-1 변수명의 길이제한은 없다. 하지만 적당히 하자*/
        int asdlkjawi9ojaskdjdlisadjfasdfkasjdtiewjaldfklajsdfasifjasdlfkjasdlf; //이건 쫌......
