...
public class Application1 {
    public static void main(String[] args){
        /*변수의 사용 목적을 이해할 수 있다*/
        /*변수의 사용 목적*/
        /*1. 값에 의미를 부여하기 위한 목적(의미 전달이 쉬어야 코드가 읽기 쉬어지고, 협업 및 유지보수에 유리하기 때문이다)*/
        /*2. 한 번 저장해둔 값을 재사용하기 위한 목적(변수를 이용하여 코드를 작성하면, 값을 변경할 때도 보다 간편하게 변경할 수 있다)*/
        /*3. 시간에 따라 변하는 값을 저장하고 사용할 수 있다(변하는 값을 저장하기 위한 공간이다)*/

        //int:정수(숫자라고 생각하면 됨), salary,bonus 변수의 이름을 지정한다
        //ex) 나이키->이름(salary) 신발박스->자료형(int)
        ...
        System.out.println("================변수 저장한 값 재사용 테스트=====================");
        ...
        sum = sum + 10;
        System.out.println("sum에 10을 더하면 현재의 sum값은? " +  sum);
