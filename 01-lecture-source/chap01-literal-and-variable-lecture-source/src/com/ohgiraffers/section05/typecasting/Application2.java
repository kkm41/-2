...
public class Application2 {
    public static void main(String[] args){
        ...
        /*
        * 강제형변환
        * 바꾸려는 자료형으로 cast 연산자를 이용하여 형변환한다
        * 예)(바꿀 자료형) 값;*/
        ...
        *  1-4 논리형은 강제형변환 규칙에서도 제외된다*/
        ...
        float fnum1 = 4.0f;
        //long lnum1 = fnum1; // 소수점 자리 이하의 데이터 손실 가능성으로 자료형의 byte값이 크더라도 불가능하다
        long lnum1 = (long)fnum1; //강제형변환의 의미는 '내가 데이터 손실을 감안할테니 형변환 해줘'라는 의미이다.
