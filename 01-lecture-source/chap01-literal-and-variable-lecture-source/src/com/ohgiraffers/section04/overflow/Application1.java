...
public class Application1 {
    public static void main(String [] args){
        ...
        * 발생한 carry를 버림 처리하고 sign bit를 반전시켜 최소값으로 순환시킴*/
        ...
        System.out.println("num2 언더플로우 : " + num2); //최대값으로 순환

        //num2 = num2 - 1; //-128을 초과해서 불가능
        ...
        System.out.println("firstNum * secondNum; : " + longMulti); //안되지? 똑같지? 이미 위에서 firstNum * secondNum 값이 확정나서 그래
