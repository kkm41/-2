...
public class Application2 {
    public static void main(String[] args){
        ...
        /* 자료형이란?
         * 다양한 값의 형태별로 어느 정도의 크기를 하나의 값으로 취급할 것인지 미리compiler와 약속한 키워드이다.
         * 예)앞에서 사용한 int 자료형은 정수를 4byte만큼 읽어서 하나의 값으로 취급하겠다는 약속이다
         * 이러한 자료형은 기본자료형(prinary type)와 참조자료형(Reference type)으로 나누어진다
         * 그 중 기본자료형 8가지부터 살펴보기로 한다*/


        /*목차 1-1-1 숫자를 취급하는 자료형*/
        /*변수를 취급하는 자료형에는 4가지가 있다*/
        ...
        /*2. 변수의 값을 대입한다(겂 대입 및 초기화)*/

        /*목차 2-1, 정수를 취급하는 자료형*/
        bnum = 1; //-128 ~ +127
        snum = 2; //-32768 ~ 32767
        inum = 3; //2147483648 ~ 2147483647
        //lnum = 8; //아무 문제 없을 것 같지만 뒤에 대문자 L을 붙여야합니다. 그 이유는 형변환에서!!
        lnum = 8L;
        ...
        * 정수는 int, 실수는 double이 대표 자료형이다*/
        // int inum;(선언), int inum = 1;(선언과 동시에 초기화가 이루어졌다)
        ...
        System.out.println("istrue의 값 출력 : " + istrue); //코딩은 위에서 아래로 해석하기 때문에 다 false가 뜬다
